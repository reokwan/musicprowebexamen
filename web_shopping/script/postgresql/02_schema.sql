...
VALUES ((SELECT id FROM supplier WHERE short_name = 'Colun'),
    (select id from product where product_name='Saxofone Yamaha' and brand_code = (SELECT id FROM brand WHERE brand_name = 'Colun')), now(), 750, 350000, 350000, 550, 550, true);

INSERT INTO stock (supplier_code, product_code, buy_date, unit_cost_price, unit_list_price, unit_sell_price, quanty_buy, quanty, active) 
VALUES ((SELECT id FROM supplier WHERE short_name = 'Soprole'),
    (select id from product where product_name='Bateria drum kit' and brand_code = (SELECT id FROM brand WHERE brand_name = 'Soprole')), now(), 740, 700000, 700000, 550, 550, true);
    
INSERT INTO stock (supplier_code, product_code, buy_date, unit_cost_price, unit_list_price, unit_sell_price, quanty_buy, quanty, active) 
VALUES ((SELECT id FROM supplier WHERE short_name = 'Surlat'),
    (select id from product where product_name='Guitarra Ibañez' and brand_code = (SELECT id FROM brand WHERE brand_name = 'Surlat')), now(), 745, 500000, 500000, 550, 550, true);    
